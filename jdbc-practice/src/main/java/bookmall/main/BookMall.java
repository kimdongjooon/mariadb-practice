...
public class BookMall {
	...
	public static void main(String[] args) {
		...
		cartdao.insert(new CartVo(1,2,1)); 
		// 3번(더 플로) 책을 5권을 1번(홍길동)이 카드에 담기.
		cartdao.insert(new CartVo(3,5,1)); 
		...
		orderdao.insert(new OrderVo(1,"서울시 강북구 미아동"));
		...
		List<OrderBookVo> list = new OrderDao().orderBookFindAll();
